...
const schema = z.object({ legalName: z.string().min(2), tradeName: z.string().optional(), countryCode: z.string().length(2), taxId: z.string().min(3), website: z.url().optional(), phone: z.string().optional(), contactEmail: z.email(), description: z.string().optional(), logoUrl: z.url().optional() });
